...
public class Lavadora1 {
    ...
    private Integer Capacidad_max = 15;//kilos de masimos a llenar
    ...
    private int RPM;
    private int Detergente = 0;//mililitros deterjente que hay en el cajetin
    private final int Detergente_max = 170;
    private String Modelo = "T1000";
    ...
    public void Lavadora(Integer Capacidad, String Plan_de_lavado, int Temperatura){
        ...
        // hañadir berificacion de los planes de lavado corto o largo o si esiste el plan
    ...
    public void VerEstado(){
        if(!Estado_lavado.equals("null")){
            ...
            for (String prenda : listaPrendas) {
                System.out.println(prenda + "Se asigno 0 a al nivel de suciedad por que se lavo");
            }
